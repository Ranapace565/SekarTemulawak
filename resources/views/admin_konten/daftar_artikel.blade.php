        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/posts/{{ $post->slug }}"
                            class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline text-s">
                            Read more
            ...
            @empty
                <div class="">
                    ...
                    <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Kembali ke halaman
                        Post</a>
                </div>
            @endforelse
        </div>
